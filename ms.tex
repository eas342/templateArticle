...
WASP-69 b is an inflated Saturn mass transiting planet (0.29 $M_{Jup}$, 1.1 $R_{Jup}$) orbiting a K5 star (4700 K, 0.83 M$_\odot$, 0.81 R$_\odot$)  with an equilibrium temperature of 963 K \citep{anderson2014wasp69wasp84wasp70Ab}.

Searches for Na in the atmospheres of WASP-69 b have yielded a scattering of results. 
WASP-69 b had a significant Na detection in high resolution that absorbs 3.3\% of the stellar flux in the Na D2 line \citep{langeveld2022surveyNaHighRes}.
Muted but significant detections of both the Na I D1 and Na I D2 lines were detected by \citep{khalafinejad2021wasp69b_lowResHighRes}.
